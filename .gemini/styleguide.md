...
- **주석**: 중요한 로직이나 의도가 불분명한 부분에는 충분한 설명을 포함하는 주석을 추가합니다. 주석은 가능한 한국어로 작성합니다.
- **검증 습관**: 작업 단위가 끝날 때마다 `lint`, `typecheck`, `build` 중 필요한 검증을 수행했는지 확인합니다.
- **커밋 단위**: 커밋은 목적별로 작게 나누고, 메시지는 `feat: ...`, `refactor: ...`, `chore: ...`, `docs: ...` 형식을 우선 사용합니다.
