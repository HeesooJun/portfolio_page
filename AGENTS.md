...
- 커밋 메시지는 반드시 Conventional Commits 형식을 사용합니다.
- 기본 형식은 `type: 변경 내용`이며, 콜론 앞에는 공백을 넣지 않습니다.
- 올바른 예시는 `feat: 프로젝트 카드 필터 기능 추가`, `fix: 모바일 헤더 겹침 수정`, `chore: 의존성 최신화`, `docs: 작업 지침 갱신`입니다.
- `feat : ...`, `chore : ...`처럼 콜론 앞에 공백이 들어간 형식은 사용하지 않습니다.
